...
public class Cliente  extends JFrame{
    ...
    private ArrayList<VentanaChatPrivado> chatsPrivados;
    ...
    public Cliente(){
        ...
        bLogout.addActionListener(new CierreConexionServidor(socketServicio, nombre, chatsPrivados));
        lstUsuarios.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               */
               ...
               VentanaChatPrivado ventana = new VentanaChatPrivado(socketServicio, nombre, cadenas[0]);
                     ...
                     case "1003": //Codigo de mensaje Privado
                         ...
                         */
                         ...
                         if(cadena[1].equals(this.nombre)){
                             ...
                             VentanaChatPrivado ventana = new VentanaChatPrivado(socketServicio, nombre, cadena[1]);
